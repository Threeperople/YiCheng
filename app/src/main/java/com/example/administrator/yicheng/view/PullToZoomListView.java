package com.example.administrator.yicheng.view;
...
public class PullToZoomListView extends ListView implements
	...
	private SimpleDraweeView mShadow;
	...
	private void init(Context paramContext) {
		...
		this.mHeaderImage = new SimpleDraweeView(paramContext);
		int i = localDisplayMetrics.widthPixels;
		setHeaderViewSize(i, (int) (9.0F * (i / 16.0F)));
		this.mShadow = new SimpleDraweeView(paramContext);
